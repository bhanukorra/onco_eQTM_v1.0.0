...
| `06_meth_drug_correlation.R` | Tests CpG methylation vs. VAEN-imputed drug sensitivity (IC₅₀) using MatrixEQTL; filters FDR ≤ 0.05, \|r\| > 0.3 |
...
| Analysis module | FDR threshold | Correlation threshold |
|-----------------|:---:|:---:|
| Core eQTM (Torch-eCpG) | ≤ 0.05 | — |
| Core eQTM (MatrixEQTL) | ≤ 0.05 | — |
| Consensus eQTM (final) | ≤ 0.05 | \|r\| > 0.3 |
| Drug sensitivity | ≤ 0.05 | \|r\| > 0.3 |
| Immune infiltration | ≤ 0.05 | \|r\| > 0.6 |
| PARADIGM pathways | ≤ 0.05 | \|r\| > 0.6 |
| miRNA cis-eQTL | ≤ 0.05 | — |

Multiple testing correction uses the Benjamini–Hochberg (BH) false discovery rate method throughout.
